...
export default function ResultPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                setLoading(true);
                console.log("Fetching feedback for:", { userId, quizId });
        ...
        const fetchTopicLevels = async () => {
            try {
                console.log("Fetching topic levels for:", { userId, quizId });
                ...
                toast.error("Failed to load topic levels");
            }
        };
        fetchData();
        fetchTopicLevels();
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    {levels.map((level, index) => (
                        <motion.div
                            ...
                            className="bg-gray-800 p-5 rounded-lg border border-blue-500/20 hover:border-blue-500/40 transition-colors"
                        >
